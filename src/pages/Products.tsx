...
export default function Products() {
  ...
  return (
    <div>
      ...
      {/* Category Filter */}
      <section className="py-4 sm:py-6 md:py-8 bg-white border-b sticky top-16 md:top-20 z-30">
        <div className="container mx-auto px-4">
          <div className="flex gap-2 sm:gap-3 overflow-x-auto pb-2 scrollbar-hide">
            <button
              onClick={() => setSelectedCategory(null)}
              className={`px-4 sm:px-5 md:px-6 py-2 sm:py-2.5 md:py-3 rounded-full text-sm sm:text-base md:text-lg font-medium whitespace-nowrap transition-all ${
